...
1. Request timeout implementation for `gthread` - https://github.com/flexlar/gunicorn/pull/1 (upstream doesn't have any, we NEED this.)
2. Higher timeout for `selector` - https://github.com/flexlar/gunicorn/pull/2 (This is a small optional performance improvement)
